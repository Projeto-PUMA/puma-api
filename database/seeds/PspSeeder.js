  ...
  static async run() {
    const psps = [
      ...
      },
      {
        title: 'PSP 6',
        psp_father_id: null,
        description: 'Engenharia do Produto',
      },
      {
        title: 'PSP 7',
        psp_father_id: null,
      ...
      },
      {
        title: 'N/A',
        psp_father_id: null,
        description: 'Não sei em qual categoria meu projeto se encaixa',
      },
      {
        title: 'Análise de Banco de Dados',
        psp_father_id: 1,
        description: 'Análise de Banco de Dados',
      },
      {
        title: 'Criação de Questionários de Pesquisa',
        psp_father_id: 1,
        description: 'Criação de Questionários de Pesquisa',
      },
      {
        title: 'Outras',
        psp_father_id: 1,
...

      {
        ...
        psp_father_id: 2,
        description: 'Projeto de Sistemas de Informação',
      },
      {
        title: 'Outras',
        psp_father_id: 2,
      ...
      {
        title: 'Definição de Objetivos Estratégicos',
        psp_father_id: 6,
        description: 'Definição de Objetivos Estratégicos',
      },
      {
        title: 'Viabilidade Econômica',
        psp_father_id: 6,
        description: 'Viabilidade Econômica',
      },
      {
        title: 'Desdobramento de Metas',
        psp_father_id: 6,
        description: 'Desdobramento de Metas',
      },
      {
        title: 'Outras',
        psp_father_id: 6,

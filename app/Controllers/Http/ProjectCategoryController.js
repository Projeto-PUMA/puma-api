...
class ProjectCategoryController {
  ...
  /**
   * Render a form to be used for creating a new projectcategory.
  ...
  /**
   * Create/save a new projectcategory.
  ...
  /**
   * Render a form to update an existing projectcategory.
  ...
  /**
   * Update projectcategory details.
   * PUT or PATCH projectcategories/:id
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
  ...
  /**
   * Delete a projectcategory with id.
